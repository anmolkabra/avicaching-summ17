...
do
    sleep .2
    ps aux | awk '{print $2, $3, $4, $11}' | sort -k2rn | head -n 10 >> ./stats/cpu_gpuset.txt && echo "----" >> ./stats/cpu_gpuset.txt
...
do
    sleep .2
    ps aux | awk '{print $2, $3, $4, $11}' | sort -k2rn | head -n 10 >> ./stats/cpu_cpuset.txt && echo "----" >> ./stats/cpu_cpuset.txt
    echo "cpuset"
done
