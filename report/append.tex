\begin{appendices}
    ...
    \begin{figure}[!htbp]
        ...
        \begin{minipage}{.49\textwidth}
            ...
            \end{axis}
            \end{tikzpicture}
            \caption[CPU Usage by Different Configurations]{CPU Usage by Different Configurations: From top - CPU ``set'', GPU ``set'', `Only LP'}
