...
\begin{document}
    ...
    \nomenclature[T]{CUDA}{NVIDIA's parallel computing API for its GPUs; stands for Compute Unified Device Architecture}
    ...
    \begin{algorithm}
        ...
        \begin{algorithmic}[1]
            ...
            \State $loss \gets \lVert \vect{y} - \mean{\vect{y}} \rVert / J$
            ...
            \State $loss \gets \Call{Phase-1-With-Rewards}{\vect{r}}$\Comment{\textbf{Phase 3: Check Constrained $\vect{r}$}}
            \State \Return $loss$
            \EndFunction
        \end{algorithmic}
    \end{algorithm}
