...
\begin{document}
    ...
    \begin{algorithm}
        ...
        \begin{algorithmic}[1]
            ...
            \For{$t = 1, 2, \dots, T$}
                ...
                \State $\matr{H} \gets \text{reLU}(\Call{Batch-Multiply}{\matr{F}, \matr{w_1}})$\Comment{\textbf{Phase 1: Feed Forward}}
    ...
    \begin{algorithm}
        ...
        \begin{algorithmic}[1]
            ...
            \State $\matr{O}_1 \gets \text{reLU}(\Call{Batch-Multiply}{\matr{F}, \matr{w_1}})$\Comment{\textbf{Phase 1: Solve for $\matr{P}$ and $loss$}}
    ...
    \begin{figure}[!htbp]
        ...
        \begin{subfigure}{\textwidth}
            ...
            \begin{tikzpicture}
                ...
                ] coordinates {(11,17.38) (55,132.80) (116,274.09)};  % cpu
                \addplot+ [mark=*,] coordinates {(11,7.84) (55,47.56) (116,156.78)};  % gpu
                \legend{CPU ``set'',GPU ``set''}
                \end{axis}
            \end{tikzpicture}
        ...
        \begin{subfigure}{.49\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \end{axis}
            \end{tikzpicture}
            \caption[Time taken by the LP]{Time taken by the LP: Unit increase in $J$ increases runtime by 1.41 seconds with GPU ``set''; 2.44 seconds with CPU ``set''}
