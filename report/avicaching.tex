...
\begin{document}
    ...
    The 3-layered neural network was run for 10000 epochs on the original dataset with learning rate = 0.01. Since we were aiming for optimization, we ran multiple tests (5 different seeds) of the model only with the GPU ``set''.\\
