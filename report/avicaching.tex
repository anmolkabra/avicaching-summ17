...
\begin{document}
    ...
    \begin{table}[!htbp]
        ...
        \label{tab:Loss Values For Different Learning Rates}
        \begin{tabular}{c | c | c}
            \hline
